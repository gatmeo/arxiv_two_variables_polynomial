...
\subsection{Symplectic Resolution}
...
\end{definition}
\subsection{Convolution Product and the Steinberg Variety}
\label{sec:steinberg}
...
\begin{theorem}[thm:stab_isom]{}
    The stable envelope becomes an isomorphism after inverting $(T \times \Chbar)$-roots in the ring $\HH^\bullet_{T\times \Chbar}(\mathrm{pt})$.
\end{theorem}
